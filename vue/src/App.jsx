...
export default function App() {
  ...
  const renderActivePage = () => {
    // Adicione um console.log aqui para depurar qual página está sendo chamada
    // console.log("Renderizando activePage:", activePage); 
    // console.log("Dados de eventos do calendário:", userData.eventosCalendario);

    switch (activePage) {
      case 'home':
        return <HomePage userData={userData} />;
      case 'calendar':
        // Verifique se eventosCalendario é um array antes de passar
      ...
      default:
        ...
        setActivePage('home'); // Força a volta para home em caso de página desconhecida
        return <HomePage userData={userData} />;
    }
  };
